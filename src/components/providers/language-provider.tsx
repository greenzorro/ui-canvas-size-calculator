...
const translations = {
  zh: {
    ...
    designWidthDescription: "您通常在哪种倍数的画布上设计App界面，没有你要的就选最接近的。",
  ...
  en: {
    ...
    designWidthDescription: "The canvas size you usually design App interfaces on. Choose the closest option if yours isn't available.",
